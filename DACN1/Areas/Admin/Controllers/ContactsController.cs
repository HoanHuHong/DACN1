...
namespace DACN1.Areas.Admin.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        public ContactsController(BanHqContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ContactId,Name,Phone,Email,Message,IsRead,CreatedDate,CreatedBy")] TbContact tbContact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContactId,Name,Phone,Email,Message,IsRead,CreatedDate,CreatedBy")] TbContact tbContact)
        {
